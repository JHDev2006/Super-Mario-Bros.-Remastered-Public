...
const MOD_DIR := "falkimore-walljumpreadd" # Name of the directory that this file is in
const LOG_NAME := "falkimore-walljumpreadd:Main" # Full ID of the mod (AuthorName-ModName)
