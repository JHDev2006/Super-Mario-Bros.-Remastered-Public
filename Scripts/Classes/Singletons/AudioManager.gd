...
const DEFAULT_SFX_LIBRARY := {
	"small_jump": ("res://Assets/Audio/SFX/SmallJump.ogg"),
	"big_jump": ("res://Assets/Audio/SFX/BigJump.ogg"),
	"coin": ("res://Assets/Audio/SFX/Coin.ogg"),
	"bump": ("res://Assets/Audio/SFX/Bump.ogg"),
	"skid": ("res://Assets/Audio/SFX/Skid.ogg"),
	"pipe": ("res://Assets/Audio/SFX/Pipe.ogg"),
	"damage": ("res://Assets/Audio/SFX/Damage.ogg"),
	"power_up": ("res://Assets/Audio/SFX/Powerup.ogg"),
	"item_appear": ("res://Assets/Audio/SFX/ItemAppear.ogg"),
	"block_break": ("res://Assets/Audio/SFX/BreakBlock.ogg"),
	"enemy_stomp": ("res://Assets/Audio/SFX/Stomp.ogg"),
	"kick": ("res://Assets/Audio/SFX/Kick.ogg"),
	"fireball": ("res://Assets/Audio/SFX/Fireball.ogg"),
	"1_up": ("res://Assets/Audio/SFX/1up.ogg"),
	"cannon": ("res://Assets/Audio/SFX/Cannon.ogg"),
	"checkpoint": ("res://Assets/Audio/SFX/Checkpoint.ogg"),
	"magic": ("res://Assets/Audio/SFX/Magic.ogg"),
	"beep": ("res://Assets/Audio/SFX/Score.ogg"),
	"switch": ("res://Assets/Audio/SFX/Switch.ogg"),
	"boo_laugh": ("res://Assets/Audio/SFX/BooLaugh.ogg"),
	"icicle_fall": ("res://Assets/Audio/SFX/IcicleFall.ogg"),
	"icicle_break": ("res://Assets/Audio/SFX/IcicleCrash.ogg"),
	"score": "res://Assets/Audio/SFX/ScoreLoop.ogg",
	"score_end": "res://Assets/Audio/SFX/Score.ogg",
	"pause": ("res://Assets/Audio/SFX/Pause.ogg"),
	"spring": ("res://Assets/Audio/SFX/Spring.ogg"),
	"swim": ("res://Assets/Audio/SFX/Swim.ogg"),
	"dry_bones_crumble": ("res://Assets/Audio/SFX/DryBonesCrumble.ogg"),
	"clock_get": ("res://Assets/Audio/SFX/ClockGet.ogg"),
	"bowser_flame": ("res://Assets/Audio/SFX/BowserFire.ogg"),
	"correct": ("res://Assets/Audio/SFX/Correct.ogg"),
	"note_block": ("res://Assets/Audio/SFX/NoteBlock.ogg"),
	"podoboo": ("res://Assets/Audio/SFX/Podoboo.ogg"),
	"hammer_throw": ("res://Assets/Audio/SFX/HammerThrow.ogg"),
	"firework": "res://Assets/Audio/SFX/Firework.ogg",
	"timer_beep": "res://Assets/Audio/SFX/TimerBeep.ogg",
	"hachisuke": "res://Assets/Audio/SFX/Hachisuke.ogg",
	"hammer_hit": "res://Assets/Audio/SFX/HammerHit.ogg",
	"burner": "res://Assets/Audio/SFX/Burner.ogg",
	"rank_up_1": "res://Assets/Audio/SFX/RankUpCBA.ogg",
	"rank_up_2": "res://Assets/Audio/SFX/RankUpSP.ogg",
	"rank_down": "res://Assets/Audio/SFX/RankDown.ogg",
	"combo_lost": "res://Assets/Audio/SFX/ComboMeterLoss.ogg",
	"lakitu_throw": "res://Assets/Audio/SFX/LakituThrow.ogg",
	"lift_fall": "res://Assets/Audio/SFX/LiftFall.ogg",
	"cheep_cheep": "res://Assets/Audio/SFX/CheepCheepJump.ogg",
	"menu_move": "res://Assets/Audio/SFX/MenuNavigate.ogg",
	"timer_warning": "res://Assets/Audio/SFX/TimerRunningLow.ogg",
	"door_open": "res://Assets/Audio/SFX/DoorOpen.ogg",
	"door_close": "res://Assets/Audio/SFX/DoorClose.ogg",
	"key_collect": "res://Assets/Audio/SFX/KeyCollect.ogg",
	"lucky_star": "res://Assets/Audio/SFX/LuckyStar.ogg",
	"bumper": "res://Assets/Audio/SFX/Bumper.ogg",
	"bumper_high": "res://Assets/Audio/SFX/BumperHigh.ogg",
	"door_unlock": "res://Assets/Audio/SFX/DoorUnlock.ogg",
	"door_locked": "res://Assets/Audio/SFX/DoorLocked.ogg"
}
...
const OVERRIDE_STREAMS := [
	...
	"res://Assets/Audio/SFX/FlagSlide.ogg",
